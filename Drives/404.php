...
<body>
	...
	<!-- footer -->
		...
		<div class="">
			<!-- container -->
			<div class="container">
				<div class="-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<p>s © 2015 CIT-PMS . 
						<a href="http://wafferdevelopers.com/">Waffer Developers</a>
					</p>
				</div>
				<div class="-right wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<ul>
						<li>
